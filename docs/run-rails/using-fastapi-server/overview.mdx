...
Open `http://localhost:8000` in your browser to inspect prompt input, output, and which rails fired.
The conversation Chat UI is available at `http://localhost:8000/chat` when the `chat-ui` extra is installed.
